  ...
  const sendOtp = async () => {
    ...
    try {
      const data = await graphqlRequest<{
        ...
        { input: { phoneNumber: normalizedPhone, role: 'AGENT' } },
        'SendLoginOtp',
      );
  ...
  const verifyOtp = async () => {
    ...
    try {
      const data = await graphqlRequest<{
        ...
        { input: { phoneNumber: normalizedPhone, otp, role: 'AGENT' } },
        'VerifyLoginOtp',
      );
      ...
      setAdminToken(data.verifyLoginOtp.token, 'AGENT');
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-3xl font-extrabold text-gray-900">Agent Login</div>
